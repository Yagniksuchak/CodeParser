...
class logChunktest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.chunk1 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk1.txt"), "C++") #Check C++
        self.chunk2 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk2.txt"), "C") #Check C
        self.chunk3 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk3.txt"), "C++") #Check C++
        #self.chunk4 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk4.txt")) #Nope
        #self.chunk5 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk5.txt")) #Nope
        self.chunk6 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk6.txt"), "C++") #Check C++
        self.chunk7 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk7.txt"), "C++") #Check C++
        self.chunk8 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk8.txt"), "C++") #Check C
        self.chunk9 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk9.txt"), "C++") #Check C++
        self.chunk10 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk10.txt"), "C++") #Check C++
        self.chunk11 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk11.txt"), "C++") #Check C++
        self.chunk12 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk12.txt"), "C++") #Check C++
        self.chunk13 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk13.txt"), "C++") #Check C++
        self.chunk14 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk14.txt"), "C++") #Check C++
        self.chunk15 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk15.txt"), "C++") #Check C++
        #self.chunk16 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk16.txt")) #Nope
        #self.chunk17 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk17.txt")) #Nope
        #self.chunk18 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk18.txt")) #Nope
        #self.chunk19 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk19.txt")) #Nope
        #self.chunk20 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk20.txt")) #Nope
        self.chunk21 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk21.txt"), "C++") #Check C++ 
        self.chunk22 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk22.txt"), "C++") #Check C++
        self.chunk23 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk23.txt"), "C++") #Check C++
        self.chunk24 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk24.txt"), "C++") #Check C++
        self.chunk25 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk25.txt"), "C") #Check C
        #self.chunk26 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk26.txt")) #Nope
        self.chunk27 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk27.txt"), "C") #Check C
        #self.chunk28 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk28.txt")) #Nope
        self.chunk29 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk29.txt"), "C") #Check C
        #self.chunk30 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk30.txt")) #Maybe?
        self.chunk31 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk31.txt"), "C++") #Check C++
        self.chunk32 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk32.txt"), "C++") #Check C++
        self.chunk33 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk33.txt"), "C++") #Check C++
        #self.chunk34 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk34.txt")) #Nope
        self.chunk35 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk35.txt"), "C") #Check C
        self.chunk36 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk36.txt"), "C++") #Check C++
        self.chunk37 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk37.txt"), "C++") #Check C++
        self.chunk38 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk38.txt"), "C++") #Check C++
        self.chunk39 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk39.txt"), "C") #C
        self.chunk40 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk40.txt"), "C") #Check C
        self.chunk41 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk41.txt"), "C++") #Check C++
        self.chunk42 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk42.txt"), "C++") # C++
        self.chunk43 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk43.txt"), "C") #Check C
        self.chunk44 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk44.txt"), "C++") # C++
        self.chunk45 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk45.txt"), "C++") # C++ 
        self.chunk46 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk46.txt"), "C++") # C++
        self.chunk47 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk47.txt"), "C++") # C++
        self.chunk48 = logChunk.logChunk(self.readHelper("./src/logChunk/testfiles/Single/testChunk48.txt"), "C++") # C++
